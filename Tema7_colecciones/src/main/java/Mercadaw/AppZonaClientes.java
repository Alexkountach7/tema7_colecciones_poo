...
/**
 * Clase principal de la aplicación de clientes.
 *
 * Aquí se controla todo el flujo del programa:
 * autenticación, creación del pedido, añadir productos
 * y mostrar opciones al usuario.
 */
public class AppZonaClientes {
    ...
    /**
     * Método main donde empieza el programa.
     *
     * Se generan los clientes, se autentica al usuario
     ...
     *
     * Pide usuario y contraseña y los compara con la lista
     * de clientes. Permite un máximo de 3 intentos.
     *
     * @param cliente conjunto de clientes registrados
     */
    ...
    /**
     * Muestra un resumen del carrito con los productos,
     * cantidades y el importe total.
     */
    ...
    /**
     * Muestra un mensaje final cuando el usuario termina el pedido.
     */
    ...
    /**
     * Muestra un menú de opciones al usuario después de hacer el pedido.
     *
     * Permite:
